...
RSpec.describe DocumentsController do
  ...
  describe 'GET /rspec/documents' do
    context 'with permission' do
      ...
      it 'retrieves all documents' do
        get :index, params: { identifier: 'rspec' }
  ...
  describe 'GET /rspec/documents/1' do
    ...
    it 'retrieves document' do
      get :show, params: { identifier: 'rspec', id: document.id }
      expect(response).to have_http_status(200)
  ...
  describe 'DELETE /rspec/documents/1' do
    ...
    it 'deletes document' do
      delete :destroy, params: { identifier: 'rspec', id: document.id }
  ...
  describe 'GET /rspec/documents/1/download' do
    context 'with permission' do
      ...
      it 'downloads current version' do
        get :download, params: { identifier: 'rspec', id: document.id }
        expect(response).to have_http_status(200)
  ...
  #       get "/rspec/documents/#{document.id}/versions/#{version.id}/download"
  #       expect(response).to have_http_status(200)
  ...
  describe 'POST /rspec/documents' do
    context 'with permission' do
      ...
      it 'uploads a top-level document' do
        ...
        post :create, params: { identifier: 'rspec', content: file }
