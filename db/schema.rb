...
ActiveRecord::Schema.define(version: 2019_05_17_055253) do
  ...
  add_foreign_key "account_users", "public.accounts", column: "account_id"
  add_foreign_key "account_users", "public.users", column: "user_id"
  ...
  add_foreign_key "users", "public.accounts", column: "default_account_id"
  add_foreign_key "users", "accounts", column: "default_account_id"
  add_foreign_key "users", "public.accounts", column: "default_account_id"
end
