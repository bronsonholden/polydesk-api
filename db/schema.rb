...
ActiveRecord::Schema.define(version: 2019_05_05_010159) do
  ...
  create_table "accounts", force: :cascade do |t|
    ...
    t.index ["default_account_id"], name: "index_accounts_on_default_account_id"
    t.index ["account_identifier"], name: "index_accounts_on_account_identifier", unique: true
  ...
  add_foreign_key "accounts", "accounts", column: "default_account_id"
end
